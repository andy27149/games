...
export const species: Species[] = [
  ...
  },
  {
    ...
    moveIds: ['liuxing_qun', 'kanglong_youhui', 'tackle', 'quick_strike'],
    color: '#7c3aed',
    shape: 'diamond',
  },
  {
    ...
    moveIds: ['shiwan_fute', 'jiaocuo_shandian', 'tackle', 'quick_strike'],
    color: '#facc15',
    shape: 'circle',
  },
  {
    ...
    moveIds: ['wuni_bo', 'du_ya', 'tackle', 'quick_strike'],
    color: '#c026d3',
    shape: 'square',
  },
];
